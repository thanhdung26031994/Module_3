...
import org.example.customer.service.CustomerServiceImpl;
...
public class CustomerServlet extends HttpServlet {
    ...
    private void updateCustomer(HttpServletRequest req, HttpServletResponse resp) {
        ...
        if (customer == null){
            ...
            req.setAttribute("message", "Thông tin khách hàng cập nhật thành công");
    ...
    private void createCustomer(HttpServletRequest req, HttpServletResponse resp) {
        ...
        req.setAttribute("message", "Tạo mới thành công");
        try {
            dispatcher.forward(req, resp);
        } catch (ServletException e) {
            throw new RuntimeException(e);
    ...
    private void showCreateCustomer(HttpServletRequest req, HttpServletResponse resp) {
        RequestDispatcher dispatcher = req.getRequestDispatcher("customer/create.jsp");
        try {
            dispatcher.forward(req,resp);
        } catch (ServletException e) {
